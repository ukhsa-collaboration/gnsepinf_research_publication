...
PA1_BR_mHES <- PA1_BR_mHES %>% mutate(gestage_grp=case_when(gestat_1 %in% c(22,23,24,25,26,27) ~ "Extremely Preterm",
...
data_3.2B <- PA1_BR_mHES %>% group_by(gestage_grp) %>% tally()
