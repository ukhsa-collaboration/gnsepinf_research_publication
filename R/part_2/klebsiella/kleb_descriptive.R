...
#########################################
##TABLES WITH kleb_FINAL DATASET
...
klebtable1a <- kleb_final %>% 
  ...
  as_gt() %>% 
  tab_header(
    title = "Table 1a. Sociodemographic characteristics of mothers and infants with **Klebsiella** bacteremia in England 2011-2019"
  ) 
...
klebtable2a <- 
  ...
  as_gt() %>% 
  tab_header(
    title = "Table 2a. Birth characteristics by outcome of mothers and infants with an **Klebsiella** episode in England 2011-2019"
  ) 
...
klebtable3a <- 
  ...
  as_gt() %>% 
  tab_header(
    title = "Table 3a. Comorbidity characteristics of infants recorded before their first **Klebsiella** bacteremia episode in England 2011-2019"
  ) 
...
klebtable4a <- 
  ...
  as_gt() %>% 
  tab_header(
    title = "Table 4a. Procedures performed on infants 28 days before their first **Klebsiella** bacteremia episode in England 2011-2019",
...
klebtable5a <- 
  ...
  as_gt() %>% 
  tab_header(
    title = "Table 5a. Procedures performed on infants 1-28 days after their first **Klebsiella** bacteremia episode in England 2011-2019",
  ) 
...
klebtable6a <- 
  ...
  as_gt() %>% 
  tab_header(
    title = "Table 6a. Other information from mothers and infants with a **Klebsiella** bacteremia in England 2011-2019"
  ) 
