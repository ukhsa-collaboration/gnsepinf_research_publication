...
#########################################
##TABLES WITH pseu_FINAL DATASET
...
pseutable1a <- pseu_final %>% 
  ...
  as_gt() %>% 
  tab_header(
    title = "Table 1a. Sociodemographic characteristics of mothers and infants with **Pseudomonas aeruginosa** bacteremia in England 2011-2019") 
...
pseutable2a <- 
  ...
  as_gt() %>% 
  tab_header(
    title = "Table 2a. Birth characteristics by outcome of mothers and infants with a **Pseudomonas aeruginosa** episode in England 2011-2019"
  ) 
...
pseutable3a <- 
  ...
  as_gt() %>% 
  tab_header(
    title = "Table 3a. Comorbidity characteristics of infants recorded before their first **Pseudomonas aeruginosa** bacteremia episode in England 2011-2019"
  ) 
...
pseutable4a <- 
  ...
  as_gt() %>% 
  tab_header(
    title = "Table 4a. Procedures performed on infants 28 days before their first **Pseudomonas aeruginosa** bacteremia episode in England 2011-2019",
...
pseutable5a <- 
  ...
  as_gt() %>% 
  tab_header(
    title = "Table 5a. Procedures performed on infants 1-28 days after their first **Pseudomonas aeruginosa** bacteremia episode in England 2011-2019",
  ) 
...
pseutable6a <- 
  ...
  as_gt() %>% 
  tab_header(
    title = "Table 6a. Other information from mothers and infants with a **Pseudomonas aeruginosa** bacteremia in England 2011-2019"
  ) 
